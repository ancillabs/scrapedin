...
from ...models.person import Experience
...
def scrape_experiences(
    page: Page, linkedin_url: str, experiences_list: List[Experience]
) -> None:
    ...
    Args:
        ...
        experiences_list: A list to append Experience objects to
    """
    # Navigate to experience details page
    experience_url = os.path.join(str(linkedin_url), "details/experience")
