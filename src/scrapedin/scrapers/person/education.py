...
from ...models.person import Education
...
def scrape_educations(
    page: Page, linkedin_url: str, educations_list: List[Education]
) -> None:
    """Scrape education information from LinkedIn profile.

    Args:
        page: Playwright page instance
        linkedin_url: The LinkedIn profile URL being scraped
        educations_list: A list to append Education objects to
    """
    # Navigate to education details page
    education_url = os.path.join(linkedin_url, "details/education")
